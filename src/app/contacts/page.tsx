        ...
        <>
            <div className="flex flex-col items-center mt-36 mb-48">
                ...
                <div className="flex w-4/5 xl:w-1/5 justify-evenly">
                    ...
                    <a
                        href="https://twitter.com/AayushK_47"
                        target="_blank"
                    ...
                    <a
                        href="https://www.linkedin.com/in/aayushk47/"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <svg
                    ...
                    <a
                        href="https://github.com/AayushK47"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <svg
                    ...
                    <a
                        href="https://www.instagram.com/aayushkurup/"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <svg
                    ...
                    <a
                        href="https://peerlist.io/aayushk47"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <svg
                    ...
                    <a
                        href="https://showwcase.aayushkurup.dev/"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        <svg
